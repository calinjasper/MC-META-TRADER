@echo off
REM Start PocketBase on Network IP
REM This script starts PocketBase to accept connections from network IP 192.168.173.112
...
REM Start PocketBase with network binding
